    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            if(c.getCount()==0){
                ...
                Toast.makeText(dbms.this, "data Not Found", Toast.LENGTH_LONG).show();
            }
            ...
            public void onClick(View view) {
                if (i <= 10) {
                    ...
                    if (a1.equals(st)) {
                        marks = marks + 4;
                        c1++;
                        Toast.makeText(dbms.this, "Successfully Submitted", Toast.LENGTH_SHORT).show();
                    } else {
                    ...
                    Intent j=new Intent(dbms.this,dbmsresult.class);
                    startActivity(j);
                }
        ...
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(dbms.this, "Skipped one question", Toast.LENGTH_SHORT).show();
                i++;
                if(i<=10) {
                    try {
                        ...
                        if (c.getCount() == 0) {
                            ...
                            Toast.makeText(dbms.this, "data Not Found", Toast.LENGTH_SHORT).show();
                        } else {
                    ...
                    Intent i1=new Intent(dbms.this,dbmsresult.class);
                    startActivity(i1);
                }
            }
        });
