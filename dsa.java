...
public class dsa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            Cursor c=obj2.dsa_quiz(i);

            if(c.getCount()==0){

                Toast.makeText(dsa.this, "data Not Found", Toast.LENGTH_LONG).show();
            }
            ...
            public void onClick(View view) {
                if (i <= 10) {
                    ...
                    if (a1.equals(st)) {
                        marks = marks + 4;
                        c1++;
                        Toast.makeText(dsa.this, "Successfully Submitted", Toast.LENGTH_SHORT).show();
                    } else {
                    ...
                    Intent j=new Intent(dsa.this,dsaresult.class);
                    startActivity(j);
                }
        ...
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(dsa.this, "Skipped one question", Toast.LENGTH_SHORT).show();
                i++;
                if(i<=10) {
                    try {
                        ...
                        if (c.getCount() == 0) {
                            ...
                            Toast.makeText(dsa.this, "data Not Found", Toast.LENGTH_SHORT).show();
                        } else {
                    ...
                    Intent i1=new Intent(dsa.this,dsaresult.class);
                    startActivity(i1);
                }
            }
        });
